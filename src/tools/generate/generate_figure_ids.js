const generate_figure_ids = (html) => {
  ...
  html = html.replace(/<div id="(fig[0-9]+-description)"/gi, '<button id="$1-button" hidden class="fig-description-button" aria-expanded="false" aria-controls="$1" data-link-id="$1" data-show-text="{{ self.show_description() }}" data-hide-text="{{ self.hide_description() }}">{{ self.show_description() }}</button><div id="$1"');
