const generate_figure_ids = (html) => {
  ...
  html = html.replace(/<div id="fig([0-9]+)-description"/gi, '<button id="$1-button" hidden class="fig-description-button" aria-expanded="false" aria-controls="fig$1-description" data-show-text="{{ show_description($1) }}" data-hide-text="{{ hide_description($1) }}">{{ show_description($1) }}</button><div id="fig$1-description"');
