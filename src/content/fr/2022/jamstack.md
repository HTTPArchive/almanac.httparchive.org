...
<aside class="note">Avertissement: les deux auteurs de ce rapport étaient des employés de Netlify. Netlify a inventé le terme Jamstack et détient Jamstack.org. Ce rapport et l'analyse sous-jacente ont été relus et approuvés par d'autres personnes non affilié à Netlify.</aside>
...
<aside class="note">Les données du rapport Chrome UX arrondissent les données CLS à la valeur la plus proche, à 0.05 près, que qui est une honte, car la vrai médiane semble se trouver autour de 0.02-0.03, donc, sur appareil portable, il arrondi à 0, et sur appareil de bureau, cela est arrondi à 0.05. Puisque 0 exclu un énorme nombre de pages, nous avons décidé d'utiliser 0.05 comme le meilleur seuil disponible, à la fois pour les appareils portables et ceux de bureaux.</aside>
