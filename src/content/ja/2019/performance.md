...
<figure id="fig8">
  <a href="/static/images/2019/07_Performance/nav-timing.png">
    <img alt="Navigation Timing API diagram of the events in a page navigation" src="/static/images/2019/07_Performance/nav-timing.png" alt="図8.ページナビゲーションのイベントとNavigation Timing API の図表。" aria-labelledby="fig8-caption" aria-describedby="fig8-description">
  </a>
