...
<a hreflang="en" href="https://ismyhostfastyet.com/">ホスティングプロバイダー</a>や<a hreflang="en" href="https://www.cdnperf.com/">CDN</a>の選択は、速度に連鎖的な影響を与えます。最速の配信に基づいてこれらの決定を行うことは、とくに低速のネットワークでは、FCPとTTFBの改善に役立ちます。FCPはフォントの読み込み時間にも大きく影響されるため、<a hreflang="ja" href="https://web.dev/i18n/ja/font-display/">Webフォントのダウンロード中にテキストが表示されるようにする</a>ことも価値のある戦略です（とくに、低速の接続ではこれらのリソースを取得するのにコストがかかる場合）。
