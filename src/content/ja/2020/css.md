...
統計の中で、いくつかの新しいメディア機能が出てきています。<a hreflang="{{ lang }}" href="https://web.dev/i18n/{{ lang }}/prefers-reduced-motion/">`prefers-reduced-motion`</a>メディア機能は、ユーザーがモーションの縮小を要求したかどうかをチェックする方法を提供します。この機能は、ユーザーが制御するオペレーティングシステムの設定で明示的にオンにすることもできますし、バッテリー残量が減っているなどの理由で暗黙的にオンにすることもできます。24%のサイトがこの機能をチェックしています。
