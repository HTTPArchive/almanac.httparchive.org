...
Lighthouseは一連のアクセシビリティ監査を提供しており、それらすべての監査の加重平均を返します（各監査の加重方法の詳細については、 <a hreflang="ja" href="https://web.dev/i18n/ja/accessibility-scoring/">スコアリングの詳細</a>を参照してください）。
