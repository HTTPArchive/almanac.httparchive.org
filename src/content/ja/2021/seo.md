...
モバイルフレンドリーに失敗した最大の理由のひとつは、13.5%のページが読みやすいフォントサイズを使用していないことでした。つまり、<a hreflang="ja" href="https://web.dev/i18n/ja/font-size/">60%以上のテキストが、モバイルで読みにくい12pxより小さいフォントサイズだった</a>ということです。
