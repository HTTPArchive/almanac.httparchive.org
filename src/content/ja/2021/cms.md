...
<aside class="note">**免責事項:** AlonはWixに勤務し、ウェブパフォーマンスの取り組みを率いていますが、意見は彼個人のものです。</aside>
...
<aside class="note">Dudaは、8月に47%のサイトが通過し、昨年から全体的に大きく進歩した点で、栄誉ある賞に値すると思います。彼らは、<a hreflang="en" href="https://github.com/AliasIO/wappalyzer/pull/4189">Wappalyzer</a>の誤った検出に関連して、7月に壊れたデータ収集のためにこのレポートに含まれておらず、彼らの起源を誤って膨らませ、彼らのCWV割合を減少させたのである。</aside>
