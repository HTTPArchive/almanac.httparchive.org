...
<figcaption>Figure 3. HTTP version usage for home pages.</figcaption>
</figure>
...
<figcaption>Figure 4. HTTP version usage for HTTPS home pages.</figcaption>
</figure>

The web is moving to HTTPS, and HTTP/2 turns the traditional argument of HTTPS being bad for performance almost completely on its head. Not every site has made the transition to HTTPS, so HTTP/2 will not even be available to those that have not. Looking at just those sites that use HTTPS, in Figure 4 we do see a higher adoption of HTTP/2 at around 55%, similar to the percent of *all requests* in Figure 1.
...
<figcaption>Figure 5. Servers used for HTTP/2.</figcaption>
</figure>
...
<figcaption>Figure 6. Servers used for HTTP/1.1 or lower.</figcaption>
</figure>
...
<figcaption>Figure 7. Percentage installs of each server used to provide HTTP/2.</figcaption>
</figure>
...
<figcaption>Figure 10. Sites using HTTP/2 push.</figcaption>
</figure>
...
<figcaption>Figure 11. How much is pushed when it is used.</figcaption>
</figure>
