...
This is perhaps unsurprising given Google Fonts dominance in the next section (`06.02`), as Google Fonts takes the lion-share of 75% of web font requests, and all of those would be third-party requests. Note that `preload` is not yet available with Google Fonts, as they generate unique URLs for their fonts, and [serve different fonts for different browsers](https://github.com/google/fonts/issues/234).
