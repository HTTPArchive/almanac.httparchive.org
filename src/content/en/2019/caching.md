...
In HTTP/1.0, the `Expires` header was used to indicate the date/time after which the response is considered stale. Its value is an date timestamp, such as:
...
<figcaption>Figure 9. `Cache Control` directives usage.</figcaption>
</figure>
