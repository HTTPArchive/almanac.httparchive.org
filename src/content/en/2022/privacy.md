...
{{ figure_markup(
  image="most-common-trackers.svg",
...
{{ figure_markup(
  image="number-of-trackers-per-site.svg",
...
{{ figure_markup(
  image="retargeting-services.svg",
...
{{ figure_markup(
  image="fingerprinting-services.svg",
...
{{ figure_markup(
  image="cname-tracking-services.svg",
...
{{ figure_markup(
  image="cname-tracking-by-rank.svg",
...
{{ figure_markup(
  image="permissions-policy-type.svg",
...
{{ figure_markup(
  image="permission-policy-features.svg",
...
{{ figure_markup(
  image="client-hints-by-rank.svg",
...
{{ figure_markup(
  image="iab-tcfv2-prevalence.svg",
...
{{ figure_markup(
  image="iab-publisher-countries.svg",
...
{{ figure_markup(
  image="privacy-link-keywords.svg",
