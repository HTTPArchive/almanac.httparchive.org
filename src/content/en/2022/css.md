...
editors: [rviscomi]
translators: []
rachelandrew_bio: Rachel Andrew works for Google as a technical writer, working on [web.dev](https://web.dev) and the [Chrome Developers site](https://developer.chrome.com/). She is a front and back-end web developer, author and speaker, author or co-author of 22 books including [The New CSS Layout](https://abookapart.com/products/the-new-css-layout) and a regular contributor to a number of publications both on and offline. Rachel is a Member of the CSS Working Group, and can be found posting photos of her cats on Twitter as [@rachelandrew](https://twitter.com/rachelandrew). 
