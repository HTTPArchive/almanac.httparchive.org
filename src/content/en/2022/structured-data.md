...
{{ figure_markup(
  ...
  description="A year on year comparison of RDFa usage on mobile",
...
We have seen an increase in use for each Open Graph type in the top 10 for both mobile and desktop, resulting in Open Graph's relative growth of 1.46% since 2021.
