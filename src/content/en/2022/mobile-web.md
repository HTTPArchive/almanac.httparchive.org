...
Being that mobile devices are so critical in people’s daily communication; it can be interesting to evaluate the most common types of link formatting that is present in the mobile web - something called ‘alternative protocol links.’ These links are described as ‘alternative protocol’ because rather than linking one page on a website to another page on a website, they link to a different type of activity, which is not just web browsing.
