...
We shall show that over the last ten years, mobile page weight has increased 594%. In this time, we've seen performance-enhancing technologies emerge to buffer the impact. More recent performance measuring methodologies Core Web Vitals like eschew page weight as a factor.
