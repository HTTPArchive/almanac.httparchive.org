...
<figure>
  <table>
    ...
    <tbody>
      <tr>
        <td><code>max-age</code> of two weeks or older <strong>and</strong> does not require revalidation.</td>
        <td class="numeric">100</td>
      </tr>
      <tr>
        <td><code>max-age</code> oftwo weeks or older <strong>and</strong> requires revalidation.</td>
        <td class="numeric">50</td>
      </tr>
    </tbody>
  </table>
...
Let's see how the delivery approaches impact Core Web Vitals. We use [Google's definition of having Good Core Web Vitals](https://web.dev/articles/vitals#core-web-vitals) where a site has:
