...
{{ figure_markup(
   ...
   caption='Bar chart showing adoption of ARIA roles on mobile web. `Button` is used on 29.0% of mobile page loads. Adoption rates for subsequent roles drops quickly with the 10th most used, `Tablist` appearing on just 7.4% of sites. Data from the [Accessibility Chapter](./accessibility)',
...
To learn more about accessibility on the mobile web, vist the [Accessibility chapter](./accessibility).
...
{{ figure_markup(
   ...
   caption='CLS performance by device. data from the [Performance Chapter](./performance)',
...
To learn more about service workers and PWA (progressive web apps), vist the [PWA chapter](./pwa).
