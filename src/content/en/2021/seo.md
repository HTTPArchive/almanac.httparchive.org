...
![](RackMultipart20211121-4-1j4blnp_html_dabbe35ecc1e41ae.png)
{# TODO (Editor) Google trends image #}
_Google Trends comparison of SEO versus pay-per-click, social media marketing, and email marketing._
...
{# TODO (Editor) Robots.txt Status Code Chart #}

_Breakdown of robots.txt status codes_
...
{# TODO (Editor) Image Robots.txt usage recommendation #}

_Breakdown of robots.txt status codes Googlebot encountered_
...
{# TODO (Editor) Robots.txt Size Chart #}

_Robots.txt size distribution_
...
| **User-agent** | **Percentage of affected websites** |
| --- | --- |
| Googlebot | 3.27% |
| Bingbot | 2.49% |
| Baiduspider | 1.91% |
...
{# TODO (Editor) Canonical Tag Usage Chart #}
{# TODO (Authors/Editors) update chart title to accurate describe contexts #}

_Canonical tag usage_
...
{# TODO (Editor) Canonical Tag Implementation Chart #}
{# TODO (Authors/Editors) update chart title to accurate describe contexts #}

_Canonical tag usage statistics_
...
{# TODO (Editor) Percentage of HTTPs Chart #}

_Percentage of Desktop and Mobile pages served with HTTPS._
...
{# TODO (Editor) Percentage of Vary Header Used Chart #}

_Vary: User-Agent header usage_
...
{# TODO (Editor) Percentage Good CWV Chart #}

_Core web vitals metrics for 2021_

See the [Performance chapter](https://almanac.httparchive.org/en/2021/performance) for more on this topic.
...
{# TODO (Editor) Title Tag and Meta Descriptions Chart #}

_Breakdown of title and meta description usage_
...
{# TODO (Editor) Title Words by Percentile Chart #}
_Number of words used in title elements_

{# TODO (Editor) Title Characters by Percentile Chart #}
_Number of characters used in title elements_
...
{# TODO (Editor) Meta Descriptions Words by Percentile Chart #}
_Number of words used in meta descriptions_

{# TODO (Editor) Meta Descriptins Characters by Percentile Chart #}
_Number of characters used in meta descriptions_
...
{# TODO (Editor) img elements per page Chart #}

_Number of images on each page_
...
{# TODO (Editor) Percentage of img alt attributes chart #}

_Percentage of images that contain image alt attributes_

{# TODO (Editor) Percentage of blank img alt attributes chart #}

_Percentage of alt attributes that were blank_

{# TODO (Editor) Percentage of missing img alt attributes chart #}

_Percentage of images missing alt attributes_
...
{# TODO (Editor) Image Loading Property Usage chart #}
_Image loading property usage_
...
{# TODO (Editor) Visible Words Rendered by Percentile chart #}
_Breakdown of words per page of rendered content_
...
{# TODO (Editor) Visible Words Raw by Percentile chart #}
_Breakdown of words per page of raw content_
...
{# TODO (Editor) Raw vs Rendered Structured Data chart #}
_Structure data usage_
...
{# TODO (Editor) Structured Data Formats chart #}

_Breakdown of structured data formats_
...
{# TODO (Editor) Popular Structured Data types chart #}
_Most popular schema types_
...
{# TODO (Editor) presence of H elements chart #}
...
{# TODO (Editor) presence of non-empty H elements chart #}

_Non-empty heading tag usage_
...
{# TODO (Editor) Outgoing Links (internal) chart #}

_Internal links from homepages_
...
{# TODO (Editor) Outgoing Links (enternal) chart #}

_External links from homepages_
...
{# TODO (Editor) Text Links chart #}

_Text links from homepages_

{# TODO (Editor) Image Links chart #}

_Image links from homepages_
...
{# TODO (Editor) Anchor Rel Attribute Usage chart #}

_Rel attribute usage_
...
{# TODO (Editor) Amp Attribute chart #}

_AMP attribute usage_
...
{# TODO (Editor) Top hreflang tag attributes chart #}
