...
featured_quote: Be part of the people who increase adoption of new standards every year. Start with something new you've learned today, one of the many standards we've covered not only in this chapter but in this whole Web Almanac.
...
Buttons are "controversial". There are a lot of opinions of what does and what doesn't constitute a button on the web. While we're not taking sides, we thought we should look at some of the semantic ways to specify a button element, seeing as how 65.5% of pages already had a `button` element in them.
