...
Images again make up the largest number of requests, though JavaScript is closing in as the gap has narrowed slightly in the last year. Images shows a reduction of 4 requests between the two years—perhaps a result of more [lazy-loading](https://developer.mozilla.org/docs/Web/Performance/Lazy_loading) since this was made available natively via simple HTML attributes?
