...
<figcaption>{{ figure_link(caption="Note the Lighthouse performance stats were incorrect for August so the `load-fast-enough-for-pwa` stat has been replaced with September results.") }}</figcaption>
</figure>
