...
These numbers hover around 60%+ through H2 and H3. The incidence rate of H4 elements is lower than 4% suggesting that that level of specificity is not required for most pages or the developers style other headings tags differently to support the visual structure of the content.
