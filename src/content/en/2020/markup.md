...
The [viewport](https://developer.mozilla.org/en-US/docs/Web/CSS/Viewport_concepts#mobile_viewports) meta element is used to control layout on mobile browsers. While years ago, the motto was kind of "don't forget the viewport meta element" when building a web page, eventually this became a common practice and the motto changed to "make sure zooming and scaling are not disabled."
