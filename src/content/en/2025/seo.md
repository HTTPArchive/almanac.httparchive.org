...
{{ figure_markup(
  image="robots-txt-user-agent-usage-all.png",
...
{{ figure_markup(
  image="robots-txt-user-agent-usage-seo-tools.png",
  ...
  chart_url="https://docs.google.com/spreadsheets/d/e/2PACX-1vQUdZ1uaX5U0oLrHlWn8iYc1dhPthw59zy20QFdsYCgky7zaesRm8ctLSxQ9zjlapXCjo6Xd29w_xmB/pubchart?oid=646503191&format=interactive",
  sheets_gid="1895020036",
  sql_file="robots-txt-user-agent-usage-2025.sql"
  )
}}
...
{{ figure_markup(
  image="robots-txt-user-agent-usage-ai.png",
...
{{ figure_markup(
  image="wordpress_seo_plugin.png",
  caption="SEO Tools",
...
{{ figure_markup(
  image="invalid-head-sites-elements.png",
...
{{ figure_markup(
  image="pages-canonical-stats.png",
...
{{ figure_markup(
  image="pages-canonical-stats-usage.png",
...
{{ figure_markup(
  image="lighthouse-seo-stats.png",
  caption="HTTPS usage",
  ...
  chart_url="https://docs.google.com/spreadsheets/d/e/2PACX-1vQUdZ1uaX5U0oLrHlWn8iYc1dhPthw59zy20QFdsYCgky7zaesRm8ctLSxQ9zjlapXCjo6Xd29w_xmB/pubchart?oid=2039418375&format=interactive",
  sheets_gid="1895020036",
...
{{ figure_markup(
  image="lighthouse-seo-stats-2.png",
...
{{ figure_markup(
  image="html-response-vary-header-used.png",
...
{{ figure_markup(
  image="image-loading-property-usage-loading-1.png",
...
{{ figure_markup(
  image="image-loading-property-usage-loading-2.png",
...
{{ figure_markup(
  image="seo-stats-by-percentile.png",
...
{{ figure_markup(
  image="seo-stats-by-percentile-percentile-1.png",
...
{{ figure_markup(
  image="seo-stats-by-percentile-percentile-3.png",
...
{{ figure_markup(
  image="seo-stats-by-percentile-percentile-4.png",
  caption="Meta description by percentile"
...
{{ figure_markup(
  image="seo-stats-elements-1.png",
...
{{ figure_markup(
  image="seo-stats-elements-2.png",
...
{{ figure_markup(
  image="image-alt-stats-alt-1.png",
...
{{ figure_markup(
  image="image-alt-stats-alt-2.png",
...
{{ figure_markup(
  image="image-alt-stats-alt-3.png",
...
{{ figure_markup(
  image="pages-containing-a-video-element.png",
...
{{ figure_markup(
  image="lighthouse-seo-stats-4.png",
...
{{ figure_markup(
  image="seo-stats-by-percentile-5.png",
...
{{ figure_markup(
  image="seo-stats-by-percentile-6.png",
...
{{ figure_markup(
  image="seo-stats-by-percentile-percentile-5.png",
...
{{ figure_markup(
  image="seo-stats-by-percentile-percentile-6.png",
...
{{ figure_markup(
  image="seo-stats-by-percentile-percentile-7.png",
...
{{ figure_markup(
  image="seo-stats-by-percentile-percentile-7-2.png",
...
{{ figure_markup(
  image="seo-stats-by-percentile-percentile-9.png",
...
{{ figure_markup(
  ...
  chart_url="https://docs.google.com/spreadsheets/d/e/2PACX-1vQUdZ1uaX5U0oLrHlWn8iYc1dhPthw59zy20QFdsYCgky7zaesRm8ctLSxQ9zjlapXCjo6Xd29w_xmB/pubchart?oid=372834420&format=interactive",
  sheets_gid="1895020036",
...
{{ figure_markup(
  image="structured-data-formats-2.png",
  ...
  chart_url="https://docs.google.com/spreadsheets/d/e/2PACX-1vQUdZ1uaX5U0oLrHlWn8iYc1dhPthw59zy20QFdsYCgky7zaesRm8ctLSxQ9zjlapXCjo6Xd29w_xmB/pubchart?oid=1584817032&format=interactive",
  sheets_gid="1895020036",
  sql_file="structured-data-formats-2025.sql"
  )
}}
...
{{ figure_markup(
  image="structured-data-schema-types-2.png",
...
{{ figure_markup(
  ...
  chart_url="https://docs.google.com/spreadsheets/d/e/2PACX-1vQUdZ1uaX5U0oLrHlWn8iYc1dhPthw59zy20QFdsYCgky7zaesRm8ctLSxQ9zjlapXCjo6Xd29w_xmB/pubchart?oid=172928571&format=interactive",
  sheets_gid="1895020036",
...
{{ figure_markup(
  ...
  chart_url="https://docs.google.com/spreadsheets/d/e/2PACX-1vQUdZ1uaX5U0oLrHlWn8iYc1dhPthw59zy20QFdsYCgky7zaesRm8ctLSxQ9zjlapXCjo6Xd29w_xmB/pubchart?oid=1904991728&format=interactive",
  sheets_gid="1895020036",
  sql_file="mark-up-stats-2025.sql"
  )
}}
...
{{ figure_markup(
  image="hreflang-link-tag-usage.png",
...
{{ figure_markup(
  image="hreflang-link-tag-usage-hreflang.png",
  caption="Hreflang link usage \- home page"
