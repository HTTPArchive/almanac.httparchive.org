...
Yash-Vekaria_bio: Yash Vekaria is a PhD candidate in Computer Science at <a hreflang="en" href="https://www.ucdavis.edu/">University of California, Davis</a>. His research interests include Web Privacy, Security and Transparency. His work aims to uncover hidden risks emerging from non-transparent data practices on the web to make it more secure and private. At a high level, he builds novel data-driven black-box audit systems to reverse-engineer opaque data and monetary flows on the Internet. More specifically, his research methods involve leveraging large-scale persona-centric internet measurement techniques by web browser instrumentation, conducting rigorous measurements of security and privacy abuses, and using insights from the measurement studies to improve the dynamics of web.
