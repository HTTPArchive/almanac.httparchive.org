...
Helaas geven onze bevindingen aan dat oneindig herhalende animaties vrij gebruikelijk zijn op internet, waarbij 21,04% van de pagina's ze gebruikt via oneindige CSS-animaties of [`<marquee>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/marquee) en [`<blink>`](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/blink) elementen.
