...
¡Guauu! ¡Menos del 2% de las páginas están usando <a hreflang="{{ lang }}" href="https://web.dev/i18n/{{ lang }}/uses-rel-preconnect">`preconnect`</a>! Dado que Google Fonts está al 75%, ¡debería ser más alto! Desarrolladores: si usa Google Fonts, use `preconnect`! Google Fonts: ¡proselitice más `preconnect`!
