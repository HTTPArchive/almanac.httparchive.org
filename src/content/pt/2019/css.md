...
una_bio: Una Kravets é palestrante internacional, escritora técnica e desenvolvedora de design de materiais do Google que mora no Brooklyn. Una hospeda a websérie <a hreflang="en" href="https://www.youtube.com/watch?v=YK8GZBx3hpg">Designing the Browser</a> e o podcast do <a hreflang="en" href="https://spec.fm/podcasts/toolsday">Toolsday</a>. Siga-a no <a href="https://twitter.com/una">Twitter</a> para encontrar suas reflexões sobre CSS criativo, experiências do usuário e melhores práticas de desenvolvimento web.Siga-a no
argyleink_bio: Adam Argyle é um membro de relações com desenvolvedores do Google Chrome focado em CSS; Ele é um viciado em web com um desejo insaciável de excelente UX & UI; Encontre-o na web <a href="https://twitter.com/argyleink">@argyleink</a> ou confira seu site <a hreflang="en" href="https://nerdy.dev">https://nerdy.dev</a>.
