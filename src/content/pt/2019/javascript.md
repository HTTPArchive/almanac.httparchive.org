...
[Preload](https://developer.mozilla.org/pt-BR/docs/Web/HTML/Link_types/preload) e [prefetch](https://developer.mozilla.org/en-US/docs/Web/HTTP/Link_prefetching_FAQ) são [dicas de recursos](./resource-hints) que permitem que você ajude o navegador a determinar quais recursos precisam ser baixados.
