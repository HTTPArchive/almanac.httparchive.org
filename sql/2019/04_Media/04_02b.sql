...
for webp when the lighthouse score is < 0.5
...
select 
      APPROX_QUANTILES( webpimgwastedms ,5) webpimgwastedms,
      APPROX_QUANTILES( webpimgwastedkb ,5) webpimgwastedkb
