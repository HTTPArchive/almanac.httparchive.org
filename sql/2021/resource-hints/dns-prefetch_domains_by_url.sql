#standardSQL
# Most popular domains users dns-prefetch to
# capped to one hit per url to avoid having the results skewed by websites which dns-prefetch the same domain many times (!)
