...
try {
    ...
    if (wpt_bodies.raw_html) {
      result.comment_count = wpt_bodies.raw_html.comment_count; // M111
      result.conditional_comment_count = wpt_bodies.raw_html.conditional_comment_count; // M112
...
SELECT
  ...
  # Comments per page
  APPROX_QUANTILES(wpt_bodies_info.comment_count, 1000)[OFFSET(percentile * 10)] AS comment_count_m111,
  APPROX_QUANTILES(wpt_bodies_info.conditional_comment_count, 1000)[OFFSET(percentile * 10)] AS conditional_comment_count_m112,
