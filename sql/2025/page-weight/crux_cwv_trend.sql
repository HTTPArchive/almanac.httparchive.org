...
SELECT
  ...
  -- FID metrics
  ROUND(APPROX_QUANTILES(fid, 1000)[OFFSET(100)], 2) AS p10_fid,
  ROUND(APPROX_QUANTILES(fid, 1000)[OFFSET(250)], 2) AS p25_fid,
  ROUND(APPROX_QUANTILES(fid, 1000)[OFFSET(500)], 2) AS p50_fid,
  ROUND(APPROX_QUANTILES(fid, 1000)[OFFSET(750)], 2) AS p75_fid,
  ROUND(APPROX_QUANTILES(fid, 1000)[OFFSET(900)], 2) AS p90_fid
