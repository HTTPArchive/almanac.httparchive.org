...
SELECT
  ...
  COUNT(DISTINCT CASE WHEN (
      REGEXP_CONTAINS(
        TO_JSON_STRING(response_headers),
  ...
  END) AS pages_with_any_security_headers,
  ...
  ROUND(
    ...
    END) * 100.0 / COUNT(DISTINCT page)), 2
...
ORDER BY
  security_headers_adoption_rate_pct DESC,
  total_pages DESC
LIMIT 100
