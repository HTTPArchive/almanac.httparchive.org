...
SELECT
  ...
  AVG(wpt_bodies_info.n_h1) AS avg_h1,
  AVG(wpt_bodies_info.n_h2) AS avg_h2,
  AVG(wpt_bodies_info.n_h3) AS avg_h3,
  AVG(wpt_bodies_info.n_h4) AS avg_h4,
  AVG(wpt_bodies_info.n_h5) AS avg_h5,
  AVG(wpt_bodies_info.n_h6) AS avg_h6,
  AVG(wpt_bodies_info.n_h7) AS avg_h7,
  AVG(wpt_bodies_info.n_h8) AS avg_h8,
