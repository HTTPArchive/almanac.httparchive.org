...
try {
    ...
    else 
    {
        ...
        if (Math.floor(Math.random() * 10) == 0) {
            wpt_bodies.hreflangs.http_header.values.push("en-us");
        }
        if (Math.floor(Math.random() * 50) == 0) {
            wpt_bodies.hreflangs.http_header.values.push("en-gb");
        }
        if (Math.floor(Math.random() * 25) == 0) {
            wpt_bodies.hreflangs.http_header.values.push("en-ca");
        }
    }
    ...
    if (wpt_bodies.hreflangs && wpt_bodies.hreflangs.http_header && wpt_bodies.hreflangs.http_header.values) {
        result.hreflangs = wpt_bodies.hreflangs.http_header.values;
    }
