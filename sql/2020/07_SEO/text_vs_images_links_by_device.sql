...
if (Math.floor(Math.random() * 50) == 0) {
    ...
    if (wpt_bodies.anchors) {
      ...
      result.images_links = wpt_bodies_info.anchors.rendered.images_links;
      result.text_links = wpt_bodies_info.anchors.rendered.text_links;
...
client,
COUNT(*) AS total, 
ROUND(AVG(wpt_bodies_info.images_links)) as images_links_avg,
ROUND(AVG(wpt_bodies_info.images_links)) as text_links_avg,
