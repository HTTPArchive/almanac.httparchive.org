...
SELECT
  ...
  APPROX_QUANTILES((bytesHtml / 1024 / 1024 / 1024) * kw_per_GB * global_grid_intensity)[OFFSET(percentile * 10)] AS html_emissions,
  APPROX_QUANTILES(bytesJS / 1024, 1000)[OFFSET(percentile * 10)] AS js_kbytes,
  APPROX_QUANTILES((bytesJS / 1024 / 1024 / 1024) * kw_per_GB * global_grid_intensity)[OFFSET(percentile * 10)] AS js_emissions,
  APPROX_QUANTILES(bytesCSS / 1024, 1000)[OFFSET(percentile * 10)] AS css_kbytes,
  APPROX_QUANTILES((bytesCSS / 1024 / 1024 / 1024) * kw_per_GB * global_grid_intensity)[OFFSET(percentile * 10)] AS css_emissions,
  APPROX_QUANTILES(bytesImg / 1024, 1000)[OFFSET(percentile * 10)] AS img_kbytes,
  APPROX_QUANTILES((bytesImg / 1024 / 1024 / 1024) * kw_per_GB * global_grid_intensity)[OFFSET(percentile * 10)] AS img_emissions,
  APPROX_QUANTILES(bytesOther / 1024, 1000)[OFFSET(percentile * 10)] AS other_kbytes,
  APPROX_QUANTILES((bytesOther / 1024 / 1024 / 1024) * kw_per_GB * global_grid_intensity)[OFFSET(percentile * 10)] AS other_emissions,
  APPROX_QUANTILES(bytesHtmlDoc / 1024, 1000)[OFFSET(percentile * 10)] AS html_doc_kbytes,
  APPROX_QUANTILES((bytesHtmlDoc / 1024 / 1024 / 1024) * kw_per_GB * global_grid_intensity)[OFFSET(percentile * 10)] AS html_doc_emissions,
