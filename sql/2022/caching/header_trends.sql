...
SELECT
  ...
  COUNTIF(uses_cache_control AND uses_expires) / COUNT(0) AS pct_using_both_max_age_and_expires,
  COUNTIF(NOT uses_cache_control AND NOT uses_expires) / COUNT(0) AS pct_using_neither_max_age_nor_expires,
